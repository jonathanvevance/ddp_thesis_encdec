...
# https://stackoverflow.com/questions/62170439/difference-between-src-mask-and-src-key-padding-mask#:~:text=Leo,to%20'%2Dinf').
...
def groupby_pad_batch(graph_tensor_2d, graph_node_labels):
    ...
    pad_mask = torch.BoolTensor((padded_tensor[:, :, 0] == 0).cpu()).t() # (B x L)
