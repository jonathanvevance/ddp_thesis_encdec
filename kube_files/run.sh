...
cd /scratch/scratch6/jonathanvevance/projects/ddp_thesis_encdec/
...
python -u ./src/train.py &>> /scratch/scratch6/jonathanvevance/projects/ddp_thesis_encdec/kube_files/logs.txt  
# python -u ./kube_files/torch_debug.py &>> /scratch/scratch6/jonathanvevance/projects/ddp_thesis_encdec/kube_files/logs.txt
